...
use firepilot_models::models::{BootSource, Drive, Logger, MachineConfiguration, NetworkInterface};
...
pub struct Configuration {
    ...
    pub machine: Option<MachineConfiguration>,
...
impl Configuration {
    ...
    pub fn with_logger(mut self, logger: Logger) -> Configuration {
        self.logger = Some(logger);
        self
    }

    pub fn with_machine_config(mut self, machine: MachineConfiguration) -> Configuration {
